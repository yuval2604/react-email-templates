...
function App() {
    return (react_1.default.createElement(react_router_1.Router, { history: history },
        react_1.default.createElement(react_router_1.Switch, null,
            react_1.default.createElement(react_router_1.Route, { path: "", render: function () { return (react_1.default.createElement(SignupWelcome_1.SignupWelcome, { subject: "Welcome to OneShip", userName: "UserName", confirmationUrl: "https://localhost:3000" })); }, exact: true }))));
}
exports.default = App;
